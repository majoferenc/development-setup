...
alias switch_cocomat="export IBMCLOUD_API_KEY=TODO_API_KEY && ibmcloud login -c TODO_ACC_ID -r eu-de && ibmcloud ks cluster config --cluster TODO_CLUSTER"
...
alias cocomat_terraform="cd /Users/marianferenc/IBM/CoCoMaT/ibm-cloud-terraform && echo \"==> Configuring Terraform COS Remote Backend\" && terraform init -reconfigure -backend-config=\"access_key=TODO_ACC_KEY\" -backend-config=\"secret_key=TODO_SECRET_KEY\""

alias ssh_vsi_vpn_fra1="ssh -i /Users/marianferenc/IBM/CoCoMaT/id_rsa_ibmcloud root@10.243.1.7"

alias eip5="ibmcloud ks cluster config --cluster eip5"
alias eip1="ibmcloud ks cluster config --cluster eip1"
alias ekp2="ibmcloud ks cluster config --cluster ekp2"
alias fs1="ibmcloud ks cluster config --cluster fs1"
alias eip-lup="ibmcloud ks cluster config --cluster eip-lup"
alias dso-fs-2="ibmcloud ks cluster config --cluster dso-fs-2"

alias k="kubectl"
alias uuid="uuidgen"
alias kns="kubens"
alias kctx="kubectx"
alias ibm_ocp_sp_vpn="openconnect 86.110.234.202 -u mferenc"
alias ibm_ocp_sp_vm="ssh mferenc@192.168.60.10"
# COCOMAT SOPS
export KEY_FP=TODO_SOPS
# COCOMAT TELEKOM GITLAB TOKEN FOR FLUX
...
alias keycloak_token='curl --location --request POST '\''https://TODO_URL/realms/TODO_REAL/protocol/openid-connect/token'\'' --header '\''Content-Type: application/x-www-form-urlencoded'\'' --data-urlencode '\''grant_type=password'\'' --data-urlencode '\''client_id=cocomat-technical-user-login'\'' --data-urlencode '\''client_secret=TODO'\'' --data-urlencode '\''username=TODO'\'' --data-urlencode '\''password=TODO'\'' --data-urlencode '\''realm=cocomat'\'' --data-urlencode '\''scope=openid'\'
alias uuid="uuidgen"
...
export JIRA_COCOMAT_PASSWORD="TODO"
export JIRA_COCOMAT_USER="TODO"
export JIRA_HOST="v"
export CONFLUENCE_COCOMAT_PASSWORD="TODO"
export CONFLUENCE_COCOMAT_USER="TODO"
...
export COCOMAT_SLACK_FLUX_TOKEN="https://hooks.slack.com/services/TODO/TODO/TODO"
